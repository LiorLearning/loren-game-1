    ...
    _create_class(StoreUI, [
        {
            ...
            value: function render() {
                ...
                // Add current DP and preview power display at the top
                ...
                const powerPreview = document.createElement('div');
                powerPreview.style.fontSize = '1.4em';
                powerPreview.style.color = '#5ff';
                powerPreview.innerHTML = `Selected Power: <span style="font-weight: bold;">⚡ ${this.previewPower}</span>`;
                topInfo.appendChild(powerPreview);

                const dpDisplay = document.createElement('div');
                dpDisplay.style.fontSize = '1.4em';
                dpDisplay.style.color = '#ffd700';
                dpDisplay.innerHTML = `Current DP: <span style="font-weight: bold;">₵ ${this.game.deploymentPoints}</span>`;
                topInfo.appendChild(dpDisplay);
                ...
                sectionsContainer.style.gridTemplateColumns = '1fr 1fr';
                    ...
                    confirmButton.onclick = () => {
                        ...
                        if (this.game.deploymentPoints >= totalCost) {
                            ...
                            if (purchaseSuccessful && this.selectedUpgrade) {
                                ...
                                for (const [upgradeName, upgradeData] of this.game.store.upgrades) {
